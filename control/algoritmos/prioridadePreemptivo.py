...
def prioridade_preemptivo(processos, ctx_time=0.5):
    tempo_atual = 0
    total_espera = 0
    total_execucao = 0
    ...
    return finalizar_metricas(total_espera, total_execucao, len(processos), Algoritmo.PRIORIDADE_PREEMPTIVO.nome_exibicao)
